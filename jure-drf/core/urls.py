...
urlpatterns = [
    ...
    path('api/v1/legal-deadlines/', include('legal_deadlines.urls')),
    path('api/v1/conflict-checks/', include('conflict_checks.urls')),
    path('api/v1/research-notes/', include('research_notes.urls')),
