...
export const TVAThresholdNotification: React.FC = () => {
  ...
  const banner = t.finance.thresholdBanner;
  ...
  return (
    <div className="shrink-0 border-b border-amber-200/80 bg-amber-50/95 px-3 py-3 dark:border-amber-900/50 dark:bg-amber-950/40 sm:px-4">
      <div className="relative mx-auto max-w-6xl rounded-xl border border-amber-200/90 bg-white/90 p-4 pe-10 shadow-sm dark:border-amber-800/60 dark:bg-slate-950/80">
        <button
          type="button"
          className="absolute end-3 top-3 rounded-md p-1 text-slate-500 hover:bg-slate-100 hover:text-slate-800 dark:hover:bg-slate-800 dark:hover:text-slate-200"
          onClick={dismiss}
