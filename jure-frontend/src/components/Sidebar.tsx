...
import { Grid3X3, Users, BookOpen, Briefcase, UserCheck, CheckSquare, MessageSquare, Settings, Sparkles, Headphones, LogOut, User, ChevronUp, UserCog, Bell, HelpCircle, Coins } from 'lucide-react';
...
const Sidebar = ({ activeTab, setActiveTab }: SidebarProps) => {
  ...
  // Filter notifications to get only messages and count unread ones
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-background shadow-lg border-t border-border">
            ...
            return (
              <button
                ...
                className={`p-2 rounded-lg transition-colors relative ${
                  isActive(item)
                    ? 'bg-jure-100 dark:bg-jure-600/20 text-jure-600 dark:text-jure-400'
            ...
            {menuItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.badge && (
                    <span className={`ml-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-xs px-1.5 py-0.5 rounded-full ${
          ...
          <div className="px-2 space-y-0.5 border-t border-border pt-3 mt-2 relative">
            ...
            <div className="relative">
              ...
              >
                ...
                <ChevronUp size={14} className={`opacity-0 group-hover:opacity-100 transition-all duration-300 ${isProfileDropdownOpen ? 'rotate-180' : ''}`} />
              </button>
