  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Desktop (md+): centered modal — preserve existing layout
        "md:inset-auto md:left-[50%] md:top-[50%] md:max-h-[min(90vh,900px)] md:max-w-lg md:translate-x-[-50%] md:translate-y-[-50%] md:rounded-lg md:overflow-y-auto",
