...
/** Dialog to pick litigation vs administrative when converting a consultation. */
export function ConversionTypeSelector({ open, onOpenChange, onSelectType }: Props) {
  const formId = useId();
...
/** @deprecated Use ConversionTypeSelector. Kept so old imports keep compiling. */
export const CaseTypeSelector = ConversionTypeSelector;
