  ...
  return (
    <>
      <button
        ...
        className="flex w-full flex-wrap items-center gap-2 border-b border-slate-100 bg-gradient-to-r from-[#64499D]/[0.04] to-transparent px-4 py-2 text-start dark:border-slate-800"
      >
