...
export interface AppMessages {
  ...
  library: {
    ...
    hub: {
      ...
      readerFit: string;
      readerReset: string;
      readerOpenTab: string;
      readerDownloadToView: string;
      readerFile: string;
  ...
  conversations: {
    ...
    groupSettingsMenu: string;
    addMembersMenu: string;
    leaveGroupMenu: string;
    deleteGroupMenu: string;
    ...
    groupSettings: {
      ...
      addMembersDescription: string;
      add: string;
      adding: string;
      noTeammatesLeft: string;
      you: string;
      admin: string;
      makeAdmin: string;
      dismissAdmin: string;
    ...
    deleteChat: {
      ...
      deleteConfirm: string;
      leave: string;
      lastMemberTitle: string;
      lastMemberConfirm: string;
      lastMemberAction: string;
    ...
    toasts: {
      ...
      couldNotAddMembers: string;
      couldNotRemoveMember: string;
      couldNotUpdateAdmin: string;
    ...
    call: {
      ...
      media: {
        ...
        permissionVoice: string;
        notFoundVideo: string;
        notFoundVoice: string;
        inUseVideo: string;
        inUseVoice: string;
        insecure: string;
        accessVideo: string;
        ...
        establishVideoConnection: string;
      };
      callingBody: string;
  ...
  juria: {
    ...
    workspace: {
      ...
      collapseThreads: string;
      expandThreads: string;
      tabs: {
        overview: string;
        chat: string;
        sources: string;
      ...
      create: {
        ...
        caseDocs: string;
        linkCaseFirst: string;
        noCaseDocuments: string;
      };
      composer: {
      ...
      activity: {
        ...
        labels: {
          ...
          PROJECT_RESTORED: string;
          PROJECT_DELETED: string;
          PROJECT_DUPLICATED: string;
          ...
          CASE_LINKED: string;
          CASE_UNLINKED: string;
          THREAD_CREATED: string;
          THREAD_ARCHIVED: string;
          ARTIFACT_CREATED: string;
          ARTIFACT_MODIFIED: string;
          ARTIFACT_EXPORTED: string;
