...
const SITELINK_SNIPPETS: Record<SitelinkRouteKey, LocalizedText> = {
  pricing: {
    ...
    ar: "اطلع على أسعار JURE لبرنامج إدارة مكاتب المحاماة للمحامين المستقلين والمكاتب والفرق.",
  },
  about: {
    ...
    ar: "تعرف على JURE، منصة LegalTech للفرق القانونية الحديثة في المغرب والشرق الأوسط وأفريقيا.",
  },
  legalPracticeManagement: {
  ...
  legalAi: {
    en: "Legal AI for lawyers inside the workspace, with lawyer review built into every workflow.",
    fr: "IA juridique pour avocats, dans l'espace de travail, avec relecture de l'avocat à chaque étape.",
    ar: "ذكاء اصطناعي قانوني للمحامين داخل مساحة العمل، مع مراجعة المحامي في كل مسار عمل.",
  },
  features: {
