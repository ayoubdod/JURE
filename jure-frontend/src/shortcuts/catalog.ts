...
export const SHORTCUT_CATALOG: CatalogItem[] = [
  ...
  { id: 'goConsultation', group: 'navigation', keys: ['G', '1'], chord: { prefix: 'g', key: '1' }, kind: 'navigate', path: '/dashboard/cases/consultation' },
  ...
  { id: 'goAppointment', group: 'navigation', keys: ['G', 'P'], chord: { prefix: 'g', key: 'p' }, kind: 'navigate', path: '/dashboard/appointment' },
